 ...
 */
function basetheme_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Base Theme default saturation level.
	 *
	 * @since Base Theme 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'basetheme_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.basetheme-front-page) .entry-title,
...
.colors-custom .basetheme-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.basetheme-front-page .panel-content .recent-posts article,
...
.colors-custom.basetheme-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Base Theme custom colors CSS.
	 *
	 * @since Base Theme 1.0
	 *
	 ...
	 */
	return apply_filters( 'basetheme_custom_colors_css', $css, $hue, $saturation );
}
